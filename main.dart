...
class CalState extends State<Calculator> {
  List content = ['7','8','9','/','4','5','6','X','1','2','3','-','.','0','00','+','CLEAR','='];
  double result = 0;
            ...
            Expanded(
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    _buildText(result.toString(), 45.0, Colors.black),
...
class CustomStk {
  ...
  doOp(symbol) {
    ...
    else if (symbol == "X") rstStk.add(num1 * num2);
